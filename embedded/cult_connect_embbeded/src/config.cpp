...
void Config::setResetModuleFlag(bool value) { this->resetModuleFlag = value; }

bool Config::getResetModuleFlag(void) { return this->resetModuleFlag; }
...
void Config::setResetButtonPin(uint8_t pin) { this->RESET_BUTTON_PIN = pin; }

void Config::setBleStatusLedPin(uint8_t pin) { this->BLE_STATUS_LED_PIN = pin; }

void Config::setSocketStatusLedPin(uint8_t pin) { this->SOCKET_STATUS_LED_PIN = pin; }

uint8_t Config::getResetButtonPin(void) { return this->RESET_BUTTON_PIN; }

uint8_t Config::getBleStatusLedPin(void) { return this->BLE_STATUS_LED_PIN; }

uint8_t Config::getSocketStatusLedPin(void) { return this->SOCKET_STATUS_LED_PIN; }
